...
public class RCprotectBlockListener implements Listener {
    final private InterfaceProtect prot;
    final private InterfaceRefineCraft ess;

    public RCprotectBlockListener(final InterfaceProtect parent) {
        this.prot = parent;
