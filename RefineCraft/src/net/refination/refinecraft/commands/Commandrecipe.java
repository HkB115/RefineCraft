...
public class Commandrecipe extends RefineCraftCommand {
    ...
    public void run(final Server server, final CommandSource sender, final String commandLabel, final String[] args) throws Exception {
        ...
        final ItemStack itemType = RC.getItemDb().get(args[0]);
        int recipeNo = 0;
        ...
        final List<Recipe> recipesOfType = RC.getServer().getRecipesFor(itemType);
