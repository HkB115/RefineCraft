...
public class Worth implements InterfaceConf {
    private final RefineCraftConf config;

    public Worth(File dataFolder) {
        config = new RefineCraftConf(new File(dataFolder, "worth.yml"));
    ...
    public int getAmount(InterfaceRefineCraft RC, User user, ItemStack is, String[] args, boolean isBulkSell) throws Exception {
        ...
        boolean requireStack = RC.getSettings().isTradeInStacks(id);
