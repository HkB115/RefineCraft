    ...
    private void createFromTemplate() {
        ...
        try {
            ...
            try {
                ...
                Logger.getLogger(RefineCraftConf.class.getName()).log(Level.SEVERE, null, ex);
            }
            try {
                if (ostr != null) {
                    ostr.close();
