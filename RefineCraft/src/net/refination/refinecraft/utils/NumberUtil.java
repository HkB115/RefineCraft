package net.refination.refinecraft.utils;
...
public class NumberUtil {
    ...
    public static String shortCurrency(final BigDecimal value, final InterfaceRefineCraft RC) {
        return RC.getSettings().getCurrencySymbol() + formatAsCurrency(value);
    }
    ...
    public static String displayCurrency(final BigDecimal value, final InterfaceRefineCraft RC) {
        return tl("currency", RC.getSettings().getCurrencySymbol(), formatAsPrettyCurrency(value));
    }

    public static String displayCurrencyExactly(final BigDecimal value, final InterfaceRefineCraft RC) {
        return tl("currency", RC.getSettings().getCurrencySymbol(), value.toPlainString());
    }
