...
public class FormatUtil {
    ...
    //RefineCraft '&' convention colour codes
    ...
    public static String stripRefineCraftFormat(final String input) {
        if (input == null) {
            return null;
        }
    ...
    public static String formatMessage(final InterfaceUser user, final String permBase, final String input) {
        if (input == null) {
            return null;
        }
    ...
    //This method is used to simply replace the RC colour codes with minecraft ones, ie &c
    ...
    public static String formatString(final InterfaceUser user, final String permBase, final String input) {
        if (input == null) {
            return null;
        }
        String message;
