...
public interface InterfaceWarps extends InterfaceConf {
    /**
     * Get a warp by name
     *
     ...
     */
    Location getWarp(String warp) throws WarpNotFoundException, net.refination.api.InvalidWorldException;
     ...
     */
    File getWarpFile(String name) throws net.refination.api.InvalidNameException;
}
