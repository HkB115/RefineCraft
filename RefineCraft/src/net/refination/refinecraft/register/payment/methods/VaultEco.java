package net.refination.refinecraft.register.payment.methods;
...
public class VaultEco implements Method {
    ...
    public boolean isCompatible(Plugin plugin) {
        try {
            ...
            return plugin instanceof Vault && ecoPlugin != null && !ecoPlugin.getProvider().getName().equals("RefineCraft Economy");
