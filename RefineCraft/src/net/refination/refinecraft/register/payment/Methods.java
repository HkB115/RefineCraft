package net.refination.refinecraft.register.payment;
...
public class Methods {
    ...
    private static void _init() {
        addMethod("iConomy", new net.refination.refinecraft.register.payment.methods.iCo6());
        addMethod("iConomy", new net.refination.refinecraft.register.payment.methods.iCo5());
        addMethod("BOSEconomy", new net.refination.refinecraft.register.payment.methods.BOSE7());
        addMethod("Currency", new net.refination.refinecraft.register.payment.methods.MCUR());
        Dependencies.add("MultiCurrency");
        addMethod("Vault", new net.refination.refinecraft.register.payment.methods.VaultEco());
    }
