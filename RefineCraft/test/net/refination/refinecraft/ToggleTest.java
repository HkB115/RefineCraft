...
public class ToggleTest extends TestCase {
    ...
    private void runCommand(String command, User user, String[] args) throws Exception {
        ...
        try {
            cmd = (InterfaceRefineCraftCommand) RefineCraft.class.getClassLoader().loadClass("net.refination.refinecraft.commands.Command" + command).newInstance();
