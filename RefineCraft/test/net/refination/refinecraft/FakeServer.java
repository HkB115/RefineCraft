...
public class FakeServer implements Server {
    ...
    public String getName() {
        return "RefineCraft Fake Server";
    }
        ...
        public void callEvent(Event event) throws IllegalStateException {
            ...
            if (event instanceof PlayerJoinEvent) {
                for (RegisteredListener listener : listeners) {
                    if (listener.getListener() instanceof RefineCraftPlayerListener) {
                        PlayerJoinEvent jEvent = (PlayerJoinEvent) event;
                        RefineCraftPlayerListener epl = (RefineCraftPlayerListener) listener.getListener();
                        epl.onPlayerJoin(jEvent);
                        RefineCraft RC = (RefineCraft) listener.getPlugin();
                        RC.getLogger().info("Sending join event to RefineCraft");
                        RC.getUser(jEvent.getPlayer());
                    }
                }
            }
        }
