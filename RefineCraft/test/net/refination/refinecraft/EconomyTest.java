...
import net.refination.refinecraft.api.NoLoanPermittedException;
import net.refination.refinecraft.api.UserDoesNotExistException;
import net.refination.api.Economy;
...
public class EconomyTest extends TestCase {
    ...
    public EconomyTest(final String testName) {
        ...
        server.addPlayer(new OfflinePlayer(PLAYERNAME, RC.getServer()));
    }
    ...
    public void testEconomy() {
        ...
        assertNotNull("NPC can be accessed", RC.getOfflineUser(NPCNAME));
        try {
